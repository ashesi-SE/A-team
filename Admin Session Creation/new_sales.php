...
<table align="center">
	...
	echo"<table>";
			...
			echo"<tr>";
				echo"<td class='formlabel'>Product Description:</td> <td><input class='textbox1' type='textarea'  style='height:100px;width:300px;font-size:14pt' name ='productDetails' id='productDetails'/></td>
			</tr>";
