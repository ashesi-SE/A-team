...
<marquee align="bottom" bgcolor="#420612" behavior="scroll" direction="left"><font face="Segoe UI Light" color="white" size="5">Welcome to popSELLOut!! The best place for all your on-line shopping. You can sell anything here.</font></marquee>
      ...
      <!-- categories list-->
					    ...
					    <ul id="horiznav">
					        ...
					        <li><a href="#">Campus Location</a>
					            ...
					            <li><a href="charlottes.php">Charlotte</a></li>
		...
		<div align="middle" class="main">
			 ...
			 <!--  search -->
					...
					<form action="searchad.php" method="post" align="right">
